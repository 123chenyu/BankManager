        ...
        <div class="span3">
            <div class="sidebar-nav">
                ...
                <ul id="legal-menu" class="nav nav-list collapse in">
                    ...
                    <li class="active"><a href="/BankManager/jspweb/terms-and-conditions.jsp">Terms and Conditions</a></li>
                </ul>
            </div>
        </div>
        <div class="span9">
            ...
            <div class="well">
                ...
                <h2>Privacy</h2>
                Please see our <a href="/BankManager/jspweb/privacy-policy.jsp">Privacy Policy</a> as set forth on the site.
